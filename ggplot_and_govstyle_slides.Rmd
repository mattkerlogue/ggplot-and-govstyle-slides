...
.small[The `scale_gov()` function from {govstyle} allows you to automatically apply the `govcols` palette to either the fill or colour grouping rather writing a custom call to `scale_*_manual()` as shown in the stacked bar chart.]
